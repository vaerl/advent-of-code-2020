...
for i in range(len(expenses)):
    for j in range(i, len(expenses)):
        if expenses[i] + expenses[j] == 2020:
            print("found:", expenses[i], expenses[j])
            print("sum:", expenses[i] + expenses[j])
    ...
    for j in range(i, len(expenses)):
        for k in range(j, len(expenses)):
            if expenses[i] + expenses[j] + expenses[k] == 2020:
                print("found:", expenses[i], expenses[j], expenses[k])
                print("sum:", expenses[i] + expenses[j] + expenses[k])
